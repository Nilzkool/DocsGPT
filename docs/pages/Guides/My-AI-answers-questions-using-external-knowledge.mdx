...
description: How to adjust your prompt to reduce AI hallucinations in DocsGPT.
---
...
- Go to one of the active prompt files, for example `application/prompts/chat_combine_default.txt`.
