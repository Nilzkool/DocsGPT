...
*   **Key Features:**
    *   Supports LLMs from OpenAI, Google, Anthropic, Groq, HuggingFace Inference API, Azure OpenAI.
    *   **Additional Supported LLMs:** The system now also supports DocsGPTAPILLM, PremAILLM, and NovitaLLM.
    *   Manages API key handling and request formatting, including tool formatting.
