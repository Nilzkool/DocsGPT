...
3. **Follow the interactive setup:**
   ...
   1) Use DocsGPT Public API Endpoint (simple and free, hosted at https://oai.arc53.com)
   ...
   * **1) Use DocsGPT Public API Endpoint (simple and free, hosted at https://oai.arc53.com):**  This is the simplest option to get started. It utilizes the DocsGPT public API hosted at https://oai.arc53.com, requiring no API keys or local model downloads. Choose this for a quick and easy setup.
