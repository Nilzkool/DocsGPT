...
<ToolCards
  ...
  },
  {
    ...
    description: 'Performs web and image searches via DuckDuckGo, returning search results and images for relevant queries.'
  },
  {
...
2.  **Configuration in UI:**
    ...
    * For tools that interact with external services (like Brave Search, DuckDuckGo, Telegram, or any service via the API Tool), you might need to provide authentication credentials (e.g., API keys, tokens) or specific endpoint information during the tool's setup in the UI.
