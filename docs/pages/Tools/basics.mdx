...
<ToolCards
  items={[
    ...
    },
    {
      ...
      description: 'Enables DocsGPT to fetch and extract textual content from specified web page URLs.'
    },
    {
      title: 'Telegram Tool',
...
* **Develop Custom Tools:** If you have specific needs not covered by built-in tools or the generic API tool, you can develop your own. See our guide on [Developing Custom Tools](/Tools/creating-a-tool).
* **Build AI Agents:** Tools are the fundamental building blocks for creating sophisticated AI agents within DocsGPT. Explore how these can be combined by looking into the [Agents section/tab concept].
