...
*   **`LLM_PROVIDER`**: This setting is essential and identifies the specific cloud provider you wish to use (e.g., `openai`, `google`, `anthropic`, etc.).
...
| PremAI                       | `premai`       | `premai-model` (example)            |
| Novita                       | `novita`       | `novita-model` (example)            |
