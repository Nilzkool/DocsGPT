...
You can find the `docker-compose-dev.yaml` file [here](https://github.com/Nilzkool/DocsGPT/blob/main/deployment/docker-compose-dev.yaml).
...
6.  **Start the Celery Worker:**
    ...
    ```bash
    celery -A application.celery_init worker -l INFO
    ```
