...
b. Type `git clone https://github.com/Nilzkool/DocsGPT.git`
...
(a) Choose the DocsGPT repo from the list of your GitHub repository that you want to deploy now.
...
*[However recommended not to disturb these options and leave them as default if not that needed.]*
